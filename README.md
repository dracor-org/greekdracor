...
Update: This corpus is currently being rebooted, also adding the latest versions from the PDL. You may already see the rebooted version on the [reboot branch](https://github.com/dracor-org/greekdracor/tree/reboot) and on the [dev server](https://dev.dracor.org/greek).
